...
var KTUsersList = function () {
    ...
    var initToggleToolbar = () => {
        ...
        const formMultiDelete = document.querySelector('#kt_delete_multi_admin_form');
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    Array.from(checkboxes).slice(1).forEach(c => {
                        if (c.checked) {
                            inputGroup += '<input type="hidden" name="usersDeleted[]" value="'+c.value+'">';
                    ...
                    setTimeout(function () {
                        Swal.fire({
                            text: "Vous avez supprimé la selection!.",
                            icon: "success",
                            buttonsStyling: false,
                            confirmButtonText: "Ok, compris!",
                            customClass: {
                    ...
                    Swal.fire({
                        text: "La selection n'a pas été supprimé.",
                        icon: "error",
                        buttonsStyling: false,
                        confirmButtonText: "Ok, compris!",
                        customClass: {

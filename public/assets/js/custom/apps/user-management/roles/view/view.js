...
var KTUsersViewRole = function () {
    ...
    var handleDeleteRows = () => {
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    text: "Êtes-vous sûr de vouloir retirer " + userName + " du tableau?",
                    icon: "warning",
                    ...
                    if (result.value) {
                        Swal.fire({
                            text: "Vous avez retiré " + userName + "!.",
                            icon: "success",
                            buttonsStyling: false,
                        ...
                        Swal.fire({
                            text: customerName + " a été retiré.",
                            icon: "error",
                            buttonsStyling: false,
                            confirmButtonText: "Ok,compris!",
                            customClass: {
    ...
    var initToggleToolbar = () => {
        ...
        deleteSelected.addEventListener('click', function () {
            // SweetAlert2 pop up --- official docs reference: https://sweetalert2.github.io/
            Swal.fire({
                text: "Êtes-vous sûr de vouloir retirer la sélection du tableau?",
                icon: "warning",
                showCancelButton: true,
                buttonsStyling: false,
                confirmButtonText: "Oui, retirer!",
                ...
                if (result.value) {
                    Swal.fire({
                        text: "Vous avez retiré la sélection!.",
                        icon: "success",
                        buttonsStyling: false,
                        confirmButtonText: "Ok, compris!",
                        customClass: {
                    ...
                    Swal.fire({
                        text: "La sélection n'a pas été retirée.",
                        icon: "error",
                        buttonsStyling: false,
                        confirmButtonText: "Ok, compris!",
                        customClass: {
